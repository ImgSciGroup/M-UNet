...
class ISBI_Loader(Dataset):
    def __init__(self, data_path, transform=None):
        ...
        self.imgs_path = glob.glob(os.path.join(data_path, 'image1/*.jpg'))
    ...
    def __getitem__(self, intex):
        ...
        label = label.reshape(label.shape[0], label.shape[1], 1)#21,21,21,1
...
if __name__ == "__main__":
    isbi_dataset = ISBI_Loader(data_path="../data/data_Italy/train",
