...
class ISBI_Loader(Dataset):
    def __init__(self, data_path, transform=None):
        ...
        self.imgs_path = glob.glob(os.path.join(data_path, 'A/*.png'))
    ...
    def __getitem__(self, intex):
        ...
        image2_path = image1_path.replace('A', 'B')
        # 根据image_path生成label_path
        label_path = image1_path.replace('A', 'label')
...
if __name__ == "__main__":
    isbi_dataset = ISBI_Loader(data_path="./samples/LEVIR-CD/train",
